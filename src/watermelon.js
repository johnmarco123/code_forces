...
// equal. The boys are extremely tired and want to start their meal as soon as
// possible, that's why you should help them and find out, if they can divide the
// watermelon in the way they want.For sure, each of them should get a part of
// positive weight.
//
//     Input The first(and the only) input line contains integer number
...
function main() {
    let t = readline();
    if (t[t.length - 1] % 2 == 0 && t != 2) console.log("YES");
    else console.log("NO");
}
